...
export const build = (cwd: string = process.cwd()): BuildType => {
  ...
  return {
    ...
    windows_x86_64: {
      ...
      -DCMAKE_INSTALL_PREFIX=../${OUTPUT_DIR}/shaderc/windows/x86_64
    `,
    ...
    windows_aarch64: {
      ...
      -DCMAKE_INSTALL_PREFIX=../${OUTPUT_DIR}/shaderc/windows/aarch64
      `,
    ...
    linux_x86_64: {
      ...
      -DCMAKE_INSTALL_PREFIX=../${OUTPUT_DIR}/shaderc/linux/x86_64,
      `,
    ...
    linux_aarch64: {
      ...
      -DCMAKE_INSTALL_PREFIX=../${OUTPUT_DIR}/shaderc/linux/aarch64
      `,
